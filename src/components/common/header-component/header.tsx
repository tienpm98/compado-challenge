...
const Header = ({ customizer, sidebar }: any) => {
				...
				<div className='main-header-right row'>
					<div className='main-header-left d-lg-none col-auto'>
						<div className='logo-wrapper'>
							<Link to={`/dashboard/overview`} style={{ display: 'flex' }}>
								<svg
					...
					<div className='nav-right col p-0'>
						<ul className={`nav-menus ${headerbar ? '' : 'open'}`}>
							...
							<UserMenu customizer={customizer} />
						</ul>
						<div
...
const StyledMaximazeItem = styled.li`
	width: 100% !important;
`
