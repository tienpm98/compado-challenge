...
const ThemeCustomizer: FC = ({ customizer }: any) => {
	...
	const handleSidebarSetting = (e: any) => {
		...
		document
			.querySelector('.page-sidebar')
			.setAttribute('sidebar-layout', e.currentTarget.getAttribute('data-attr'))
	...
	const colorChangeTheme = (value: string) => {
		if (value === 'light-1') {
			...
			<div className='customizer-contain'>
				<div className='tab-content' id='c-pills-tabContent'>
					<div className='customizer-header'>
						<i className='icon-close' onClick={customizer.close}></i>
					</div>
